...
namespace MVC_Blog_Uygulama.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public PartialViewResult KategoriListesi() //kategoriPartialView için
        {
            var kategoriler = db.Kategori.Select(i => new KategoriModel
            {
                id = i.ID,
                KategoriAdi = i.KategoriAdi,
                BlogSayisi = i.Blog.Where(a => a.Onay == true).Count()
            }).ToList();
        ...
        {
            return View(db.Kategori.Select(i => new KategoriModel()
            {
                id = i.ID,
                BlogSayisi = i.Blog.Count(),
                KategoriAdi = i.KategoriAdi
            }).ToList());
        }
